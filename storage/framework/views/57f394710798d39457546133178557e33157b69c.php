                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <h6 class="mb-1 text-muted">Active Plan(s)</h6>
                                                <span class="mb-0 h5 font-weight-bold"><?php echo e($plans ? count($plans) : '0'); ?></span>
...
<?php echo $__env->make('layouts.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/minerone/account/resources/views/user/dashboard.blade.php ENDPATH**/ ?>