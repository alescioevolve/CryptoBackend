...
} elseif ($_instance->childHasBeenRendered('whrm0QO')) {
    $componentId = $_instance->getRenderedChildComponentId('whrm0QO');
    $componentTag = $_instance->getRenderedChildComponentTagName('whrm0QO');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('whrm0QO');
} else {
    $response = \Livewire\Livewire::mount('user.crypto-withdaw', ['paymentMode' => $payment_mode,'payment_mode' => $payment_mode]);
    $html = $response->html();
    $_instance->logRenderedChild('whrm0QO', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                    <?php else: ?>
...
<?php echo $__env->make('layouts.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/minerone/account/resources/views/user/withdraw.blade.php ENDPATH**/ ?>