...
} elseif ($_instance->childHasBeenRendered('HdDei8m')) {
    $componentId = $_instance->getRenderedChildComponentId('HdDei8m');
    $componentTag = $_instance->getRenderedChildComponentTagName('HdDei8m');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('HdDei8m');
} else {
    $response = \Livewire\Livewire::mount('user.crypto-payment', []);
    $html = $response->html();
    $_instance->logRenderedChild('HdDei8m', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                                <?php else: ?>
                                            ...
                                            <?php else: ?>
                                                ...
                                                <div class="mb-3 form-group">
                                                    <input type="text" class="form-control readonly" 
                                                        value="<?php echo e($payment_mode->wallet_address); ?>" id="myInput" readonly>
                                                    ...
                                                    <button onclick="myFunction()" onmouseout="outFunc()">
                                                      ...
                                                      <?php echo e($payment_mode->name); ?> Address
                                                    </button>
...
<!--SCRIPT FOR COPY ACTION TOOLTIP-->
...
<!--END SCRIPT FOR COPY ACTION TOOLTIP-->

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/minerone/account/resources/views/user/payment.blade.php ENDPATH**/ ?>