...
} elseif ($_instance->childHasBeenRendered('z7NOD7h')) {
    $componentId = $_instance->getRenderedChildComponentId('z7NOD7h');
    $componentTag = $_instance->getRenderedChildComponentTagName('z7NOD7h');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('z7NOD7h');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('z7NOD7h', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/minerone/account/resources/views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>