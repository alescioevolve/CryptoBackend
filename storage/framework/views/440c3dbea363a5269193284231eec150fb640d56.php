...
} elseif ($_instance->childHasBeenRendered('N9X0ABF')) {
    $componentId = $_instance->getRenderedChildComponentId('N9X0ABF');
    $componentTag = $_instance->getRenderedChildComponentTagName('N9X0ABF');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('N9X0ABF');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('N9X0ABF', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?><?php /**PATH /home/minerone/account/resources/views/admin/Settings/AppSettings/theme.blade.php ENDPATH**/ ?>