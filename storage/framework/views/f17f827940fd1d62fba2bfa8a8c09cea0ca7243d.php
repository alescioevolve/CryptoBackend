            ...
            <form method="POST" action="<?php echo e(route('updatemethod')); ?>" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                        ...
                        <?php if($method->defaultpay == 'yes'): ?>
                            <input type="text" class="form-control  " name="name" placeholder="Payment method name"
                                value="<?php echo e($method->name); ?>" readonly>
                        <?php else: ?>
                            <input type="text" class="form-control  " name="name" placeholder="Payment method name"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" value="<?php echo e($method->minimum); ?>" class="form-control  " name="minimum"
                            id="minamount" required>
                        <small class="">Required but only applies to withdrawal</small>
                    </div>
                    <div class="form-group col-md-6">
                        <h6 class="">Maximum Amount</h6>
                        <input type="number" value="<?php echo e($method->maximum); ?>" class="form-control  " name="maximum"
                            id="maxamount" required>
                        <small class="">Required but only applies to withdrawal</small>
                    </div>
                    <div class="form-group col-md-6">
                        <h6 class="">Charges</h6>
                        <input type="number" value="<?php echo e($method->charges_amount); ?>" class="form-control  " name="charges"
                            id="charges" required>
                        <small class="">Required but only applies to withdrawal</small>
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" value="<?php echo e($method->img_url); ?>" class="form-control  " name="url"
                            id="url">
                    </div>
                    ...
                    <div class="form-group col-md-6 currency">
                        ...
                        <input type="text" value="<?php echo e($method->account_name); ?>" class="form-control   currinput"
                            name="account_name" id="acnt_name">
                    </div>
                    <div class="form-group col-md-6 currency">
                        <h6 class="">Account Number</h6>
                        <input type="number" value="<?php echo e($method->account_number); ?>" class="form-control   currinput"
                            name="account_number" id="acnt_number">
                    </div>
                    <div class="form-group col-md-6 currency">
                        <h6 class="">Swift/Other Code</h6>
                        <input type="text" value="<?php echo e($method->swift_code); ?>" class="form-control   currinput"
                            name="swift" id="swift">
                    </div>
                    ...
                    <div class="form-group col-md-6 d-none crypto">
                        ...
                        <input type="text" value="<?php echo e($method->wallet_address); ?>" class="form-control   cryptoinput"
                    ...
                    <div class="form-group col-md-6 d-none crypto">
                        ...
                        <input type="text" value="<?php echo e($method->network); ?>" class="form-control   cryptoinput"
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" value="<?php echo e($method->duration); ?>" class="form-control  " name="note"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/minerone/account/resources/views/admin/Settings/PaymentSettings/editpaymethod.blade.php ENDPATH**/ ?>