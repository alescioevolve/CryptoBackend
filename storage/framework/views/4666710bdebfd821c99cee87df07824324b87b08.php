            ...
            <div class="p-3 card ">
                <form role="form" method="post" action="<?php echo e(route('addplan')); ?>">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            <h5 class="">Add Other Information</h5>
                            <input class="form-control" placeholder="eg Referral Bonus " type="text"
                                name="OtherDetails" >
                            <!--<small class="">This specifies how long the investment plan-->
                            <!--    will run. Please strictly follow the guide on <a href="" data-toggle="modal"-->
                            <!--        data-target="#durationModal">how to setup investment-->
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/minerone/account/resources/views/admin/Plans/newplan.blade.php ENDPATH**/ ?>