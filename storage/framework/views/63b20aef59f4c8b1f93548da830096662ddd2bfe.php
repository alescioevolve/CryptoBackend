            ...
            <div class="">
                <?php if($method->defaultpay == 'yes'): ?>
                    ...
                    <?php elseif($withdrawal->payment_mode == 'USDT'): ?>
                        ...
                        <input type="text" class="form-control readonly  " value="<?php echo e($withdrawal->duser->usdt_address); ?>"
                            readonly>
                    <?php elseif($withdrawal->payment_mode == 'BUSD'): ?>
                        <h5 class="">BUSD Address</h5>
                        <input type="text" class="form-control readonly  " value="<?php echo e($withdrawal->paydetails); ?>"
                            readonly>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/minerone/account/resources/views/admin/Withdrawals/pwithrdawal.blade.php ENDPATH**/ ?>