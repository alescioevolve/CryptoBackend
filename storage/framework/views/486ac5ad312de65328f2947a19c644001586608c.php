                ...
                <form role="form" method="post" action="<?php echo e(route('updateplan')); ?>">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control  " value="<?php echo e($plan->name); ?>" placeholder="Enter Plan name"
                                type="text" name="name" required>
                        </div>
                        <div class="form-group col-md-6">
                            <h5 class="">Plan price(<?php echo e($settings->currency); ?>)</h5>
                            <input class="form-control  " value="<?php echo e($plan->price); ?>" placeholder="Enter Plan price"
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control  " value="<?php echo e($plan->minr); ?>" placeholder="Enter minimum return"
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control  " value="<?php echo e($plan->maxr); ?>" placeholder="Enter maximum return"
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control  " value="<?php echo e($plan->increment_amount); ?>" placeholder="top up amount"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/minerone/account/resources/views/admin/Plans/editplan.blade.php ENDPATH**/ ?>